...
class CAPM:
    ...
    def initialize(self):
        stock_data = self.download_Date()
        # print(stock_data)

        # using monthly returns instead of daily returns
    ...
    def plot_regression(self, alpha, beta):
        ...
        plt.title('caaptial asset pricing model, finding alphas and betas')
